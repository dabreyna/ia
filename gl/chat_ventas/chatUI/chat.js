class ChatClient {
    ...
    async sendMessage() {
       ...
       // if (this.firstMessage) {
        ...
        // if (!this.getIsExistingCustomer()) {
        if (this.firstMessage) {
            const lowerText = text.toLowerCase();
            if (lowerText.includes('si') ||lowerText.includes('si soy') || lowerText.includes('sí') || lowerText.includes('yes') || 
                lowerText.includes('ya soy cliente') || lowerText.includes('soy cliente') || 
                lowerText.includes('tengo un terreno') || lowerText.includes('ya compré') ||
                lowerText.includes('ya tengo') || lowerText.includes('ya soy')) {
                this.setIsExistingCustomer(true);
            } else if (lowerText.includes('no') || lowerText.includes('no soy') || 
                       lowerText.includes('primera vez') || lowerText.includes('es mi primera') ||
                       lowerText.includes('nuevo') || lowerText.includes('nueva')) {
        ...
        try {
            ...
            formData.append('isExistingCustomer', this.getIsExistingCustomer().toString());
