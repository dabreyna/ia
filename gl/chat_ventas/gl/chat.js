class ChatClient {
  ...
  async sendMessage() {
    ...
    //const n8nWebhookUrl = "https://n8n.srv655139.hstgr.cloud/webhook/chat-ventas-gl";
    const n8nWebhookUrl = "http://localhost:5678/webhook/chat-ventas-gl";
    ...
    try {
      // Preparamos el cuerpo del mensaje exactamente como lo hacía el PHP
      const payload = {
        message: text,
